...
if __name__ == '__main__':
    ...
    vgg16 = torch.hub.load('pytorch/vision:v0.10.0', 'vgg16').cuda().eval()
    ...
    for filename in tqdm(filenames):
        ...
        feature_data_path = str(Path(args.outdir).resolve().joinpath(image_fn)) + "-vgg16.npy"
        ...
        with torch.no_grad():
            ...
            vgg_features = torch.mean(vgg_features, dim=2).cpu().numpy()

            np.save(feature_data_path, vgg_features)
